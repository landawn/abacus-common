...
public class Logger100Test extends TestBase {
    ...
    // Mock implementation of Logger interface for testing
    ...
    public void testTraceMethods() {
        ...
        // Test with exception (alternate order)
        logger.trace(ex, "Message");
        assertEquals(11, logger.traceCount);
        assertSame(ex, logger.lastThrowable);
        
        // Test with exception and template
        ...
        // Test with supplier and exception (deprecated)
        logger.trace(() -> "Supplier with exception", ex);
        assertEquals(16, logger.traceCount);
        assertSame(ex, logger.lastThrowable);
        
        // Test with exception and supplier
    ...
    public void testSupplierLazyEvaluation() {
        ...
        // Supplier should be called since logging is enabled
    ...
    public void testDeprecatedMethods() {
        ...
        // Test deprecated supplier methods with exception as second parameter
        ...
        // Test deprecated varargs methods
