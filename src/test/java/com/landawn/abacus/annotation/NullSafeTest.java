...
public class NullSafeTest extends TestBase {
    static class TestClass {
        ...
        @NullSafe
        public TestClass(@NullSafe String value) {
        }
    }
    ...
    public void testMethodAnnotation() throws NoSuchMethodException {
        ...
        assertTrue(method.isAnnotationPresent(NullSafe.class));
    }
    ...
    public void testParameterAnnotation() throws NoSuchMethodException {
        ...
        assertTrue(params[0].isAnnotationPresent(NullSafe.class));
    }
    ...
    public void testConstructorAnnotation() throws NoSuchMethodException {
        ...
        assertTrue(constructor.isAnnotationPresent(NullSafe.class));
    }
    ...
    public void testRetentionPolicy() {
        Retention retention = NullSafe.class.getAnnotation(Retention.class);
    ...
    public void testTargetElements() {
        Target target = NullSafe.class.getAnnotation(Target.class);
    ...
    public void testDocumented() {
        assertTrue(NullSafe.class.isAnnotationPresent(Documented.class));
    }

    @Test
    public void testIsAnnotation() {
        assertTrue(NullSafe.class.isAnnotation());
    }

    @Test
    public void testAnnotationType() throws NoSuchMethodException {
        Method method = TestClass.class.getDeclaredMethod("method", String.class);
        NullSafe annotation = method.getAnnotation(NullSafe.class);
        assertNotNull(annotation);
        assertEquals(NullSafe.class, annotation.annotationType());
    }

    @Test
    public void testNoMethods() {
        Method[] methods = NullSafe.class.getDeclaredMethods();
