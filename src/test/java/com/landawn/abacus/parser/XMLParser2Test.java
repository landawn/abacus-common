...
public class XMLParser2Test extends AbstractParserTest {
    ...
    public void test_prettyFormat() {
        ...
        str = xmlParser.serialize(N.asArray(account, account), config);
        ...
        str = xmlParser.serialize(Beans.deepBean2Map(account), config);
        N.println("============(N.deepBean2Map(account)==================================================================================");
        N.println(str);
        N.println("========================================================================================================================");

        str = xmlParser.serialize(new Object[] { Beans.deepBean2Map(account), account }, config);
        N.println("============Array.of(N.deepBean2Map(account), account)===============================================================");
        N.println(str);
        N.println("========================================================================================================================");

        str = xmlParser.serialize(N.asList(Beans.deepBean2Map(account), account), config);
        ...
        str = xmlParser.serialize(xBean, config);

        N.println("============xBean=======================================================================================================");
        N.println(str);
        N.println("========================================================================================================================");

        str = xmlParser.serialize(N.asArray("abc", "123"), config);
