...
public class JSONParser2Test extends AbstractParserTest {
    ...
    public void test_prettyFormat() {
        ...
        str = jsonParser.serialize(Beans.deepBean2Map(account), config);
        N.println("============(N.deepBean2Map(account)==================================================================================");
        N.println(str);
        N.println("========================================================================================================================");

        str = jsonParser.serialize(new Object[] { Beans.deepBean2Map(account), account }, config);
        N.println("============Array.of(N.deepBean2Map(account), account)===============================================================");
        N.println(str);
        N.println("========================================================================================================================");

        str = jsonParser.serialize(N.asList(Beans.deepBean2Map(account), account), config);
