...
@Tag("2025")
public class PrimitiveShortType2025Test extends TestBase {

    private final PrimitiveShortType type = new PrimitiveShortType();

    @Test
    public void test_set_PreparedStatement() throws SQLException {
        PreparedStatement stmt = mock(PreparedStatement.class);

        type.set(stmt, 1, (short) 12345);
    ...
    public void test_set_CallableStatement() throws SQLException {
        ...
        type.set(stmt, "param1", (short) 9999);
