...
public class MutableByteTypeTest extends TestBase {
    ...
    public void testSerializeToWithNull() throws IOException {
        assertDoesNotThrow(() -> {
            mutableByteType.serializeTo(characterWriter, null, null);
        });
    }
    ...
    public void testSerializeToWithNullHonorsWriteNullNumberAsZero() throws IOException {
        ...
        mutableByteType.serializeTo(characterWriter, null, config);

        Mockito.verify(characterWriter).write((byte) 0);
    }
