...
@Tag("2025")
public class MutableCharType2025Test extends TestBase {

    private final MutableCharType type = new MutableCharType();
    ...
    public void test_get_PreservesZeroValue() throws SQLException {
        ...
        MutableChar result = type.get(rs, 1);
    ...
    public void test_set_CallableStatement_NullUsesSqlNull() throws SQLException {
        ...
        verify(stmt).setNull("param", Types.INTEGER);
    }
}
