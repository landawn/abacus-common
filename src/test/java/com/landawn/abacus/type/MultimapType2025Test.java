...
@Tag("2025")
public class MultimapType2025Test extends TestBase {

    private final MultimapType type = new MultimapType(com.landawn.abacus.util.Multimap.class, "String", "String", "List<String>");
