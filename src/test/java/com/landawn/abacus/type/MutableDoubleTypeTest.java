...
public class MutableDoubleTypeTest extends TestBase {
    ...
    public void testSerializeToWithNull() throws IOException {
        assertDoesNotThrow(() -> {
            mutableDoubleType.serializeTo(characterWriter, null, null);
        });
    }
    ...
    public void testSerializeToWithNullHonorsWriteNullNumberAsZero() throws IOException {
        ...
        mutableDoubleType.serializeTo(characterWriter, null, config);

        Mockito.verify(characterWriter).write(0.0d);
    }

    @Test
    public void testSerializeToWithNonNull() throws IOException {
        assertDoesNotThrow(() -> {
            mutableDoubleType.serializeTo(characterWriter, MutableDouble.of(3.0), null);
        });
    }
}
