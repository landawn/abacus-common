...
@Tag("2025")
public class RangeType2025Test extends TestBase {

    private final RangeType type = new RangeType("Integer");
    ...
    public void test_name() {
        assertEquals("Range<Integer>", type.name());
    }

    @Test
    public void test_stringOf() {
        Range<Integer> range = Range.openClosed(1, 10);
        assertNotNull(type.stringOf(range));
