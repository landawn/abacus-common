...
@Tag("2025")
public class MutableDoubleType2025Test extends TestBase {

    private final MutableDoubleType type = new MutableDoubleType();
    ...
    public void test_get_PreservesZeroValue() throws SQLException {
        ...
        MutableDouble result = type.get(rs, 1);
    ...
    public void test_get_ReturnsNullWhenJdbcValueIsNull() throws SQLException {
        ...
        when(rs.getDouble("col")).thenReturn(0D);
    ...
    public void test_set_CallableStatement_NullUsesSqlNull() throws SQLException {
        ...
        verify(stmt).setNull("param", Types.DOUBLE);
    }
}
