...
public class NamingPolicyTest extends AbstractParserTest {
    ...
    @Test
    public void test_kebabCase_convert_withCamelCase() {
    ...
    @Test
    public void test_kebabCase_convert_withUpperCamelCase() {
        assertEquals("user-name", NamingPolicy.KEBAB_CASE.convert("UserName"));
        assertEquals("user-id", NamingPolicy.KEBAB_CASE.convert("UserId"));
        assertEquals("first-name", NamingPolicy.KEBAB_CASE.convert("FirstName"));
    }
    ...
    @Test
    public void test_kebabCase_convert_emptyString() {
        assertEquals("", NamingPolicy.KEBAB_CASE.convert(""));
    }

    @Test
    public void test_kebabCase_convert_singleWord() {
        assertEquals("user", NamingPolicy.KEBAB_CASE.convert("user"));
        assertEquals("user", NamingPolicy.KEBAB_CASE.convert("USER"));
    }

    @Test
    public void test_kebabCase_convert_alreadyKebabCase() {
        assertEquals("user-name", NamingPolicy.KEBAB_CASE.convert("user-name"));
        assertEquals("user-id", NamingPolicy.KEBAB_CASE.convert("user-id"));
    }
    ...
    @Test
    public void test_kebabCase_func_returnsFunction() {
        Function<String, String> converter = NamingPolicy.KEBAB_CASE.asFunction();
        assertNotNull(converter);
        assertEquals("user-name", converter.apply("userName"));
    }
    ...
    public void test_enumValues_allPresent() {
        ...
        assertNotNull(NamingPolicy.KEBAB_CASE);
