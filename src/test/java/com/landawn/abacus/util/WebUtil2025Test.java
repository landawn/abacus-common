...
public class WebUtil2025Test extends TestBase {
    ...
    public void testCreateOkHttpRequestForCurl_TwoParams_HttpsUrl() {
        OkHttpRequest request = WebUtil.createCurlLoggingOkHttpRequest("https://secure.example.com/api", curl -> {
        });
    ...
    public void testCreateOkHttpRequestForCurl_ThreeParams_UrlNotNull() {
        OkHttpRequest request = WebUtil.createCurlLoggingOkHttpRequest("https://api.example.com/v1/users", '"', curl -> {
        });
    ...
    public void testCreateOkHttpRequestForCurl_ThreeParams_ComplexUrl() {
        OkHttpRequest request = WebUtil.createCurlLoggingOkHttpRequest("https://api.example.com/v1/users?page=1&limit=10", '\'', curl -> {
        });
