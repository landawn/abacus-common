...
public class ObjectPoolTest extends TestBase {
    ...
    public void testHashCode() {
        ...
        ObjectPool<String, Integer> emptyPool = new ObjectPool<>(10);
        Assertions.assertEquals(emptyPool.hashCode(), new ObjectPool<>(10).hashCode());
    }
    ...
    public void testEquals() {
        ...
        Assertions.assertEquals(pool1, pool1);

        ObjectPool<String, Integer> pool3 = new ObjectPool<>(10);
        pool3.put("a", 1);
        pool3.put("b", 3);
        Assertions.assertNotEquals(pool1, pool3);

        Assertions.assertNotEquals(pool1, null);
        Assertions.assertNotEquals(pool1, "not a map");

        // Test equals with a regular HashMap
        Map<String, Integer> map = new HashMap<>();
        map.put("a", 1);
        map.put("b", 2);
        Assertions.assertEquals(pool1, map);

        // Test empty pools are equal
        ObjectPool<String, Integer> empty1 = new ObjectPool<>(10);
        ObjectPool<String, Integer> empty2 = new ObjectPool<>(5);
    ...
    public void testToString() {
        ...
        ObjectPool<String, Integer> emptyPool = new ObjectPool<>(10);
        String emptyStr = emptyPool.toString();
