...
public class Numbers102Test extends TestBase {
    ...
    public void testCreateBigInteger() {
        Assertions.assertEquals(new BigInteger("123456789012345678901234567890"), Numbers.createBigInteger("123456789012345678901234567890"));
        Assertions.assertEquals(new BigInteger("-123456789012345678901234567890"), Numbers.createBigInteger("-123456789012345678901234567890"));
    ...
    public void testCreateBigDecimal() {
        Assertions.assertEquals(new BigDecimal("123.456789012345678901234567890"), Numbers.createBigDecimal("123.456789012345678901234567890"));
        Assertions.assertEquals(new BigDecimal("-123.456789012345678901234567890"), Numbers.createBigDecimal("-123.456789012345678901234567890"));
    ...
    public void testIsParsable() {
        ...
        Assertions.assertFalse(Numbers.isParsable("1.23e5"));
        Assertions.assertFalse(Numbers.isParsable("0x1A"));
        Assertions.assertFalse(Numbers.isParsable("-"));
        Assertions.assertFalse(Numbers.isParsable("+"));
    }
    ...
    public void testIsPerfectSquare() {
        ...
        Assertions.assertTrue(Numbers.isPerfectSquare(1000000L));
