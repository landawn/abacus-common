...
public class IntToFloatFunctionTest extends TestBase {

    @Test
    public void test_DEFAULT() {
        assertEquals(100f, IntToFloatFunction.DEFAULT.applyAsFloat(100));
        assertEquals(0f, IntToFloatFunction.DEFAULT.applyAsFloat(0));
