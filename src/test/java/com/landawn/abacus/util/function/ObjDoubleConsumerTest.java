...
public class ObjDoubleConsumerTest extends TestBase {
    ...
    public void testAcceptWithAnonymousClass() {
        final List<String> result = new ArrayList<>();
        ObjDoubleConsumer<String> consumer = new ObjDoubleConsumer<>() {
            @Override
    ...
    public void testAndThenNullThrowsImmediately() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(IllegalArgumentException.class, () -> instance.andThen((ObjDoubleConsumer) null));
    }
}
