...
public class ObjCharConsumerTest extends TestBase {
    ...
    public void testAcceptWithAnonymousClass() {
        final List<String> result = new ArrayList<>();
        ObjCharConsumer<String> consumer = new ObjCharConsumer<>() {
            @Override
    ...
    public void testAndThenNullThrowsImmediately() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(IllegalArgumentException.class, () -> instance.andThen((ObjCharConsumer) null));
    }
}
