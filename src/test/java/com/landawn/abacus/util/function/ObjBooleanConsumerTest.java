...
public class ObjBooleanConsumerTest extends TestBase {
    ...
    public void testAcceptWithAnonymousClass() {
        final List<String> result = new ArrayList<>();
        ObjBooleanConsumer<String> consumer = new ObjBooleanConsumer<>() {
            @Override
    ...
    public void testAndThenNullThrowsImmediately() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(IllegalArgumentException.class, () -> instance.andThen((ObjBooleanConsumer) null));
    }
}
