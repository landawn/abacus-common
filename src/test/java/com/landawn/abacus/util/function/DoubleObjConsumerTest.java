...
public class DoubleObjConsumerTest extends TestBase {
    ...
    public void testAcceptWithAnonymousClass() {
        final List<String> result = new ArrayList<>();
        DoubleObjConsumer<String> consumer = new DoubleObjConsumer<>() {
            @Override
    ...
    public void testAndThenNullThrowsImmediately() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(IllegalArgumentException.class, () -> instance.andThen((DoubleObjConsumer) null));
    }
}
