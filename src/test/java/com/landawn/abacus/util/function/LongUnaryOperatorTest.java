...
public class LongUnaryOperatorTest extends TestBase {
    ...
    public void testComposeRejectsNullImmediately() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(IllegalArgumentException.class, () -> instance.compose((java.util.function.LongUnaryOperator) null));
        org.junit.jupiter.api.Assertions.assertThrows(IllegalArgumentException.class, () -> instance.andThen((java.util.function.LongUnaryOperator) null));
    }
}
