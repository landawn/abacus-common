...
public class AddrUtilTest extends AbstractTest {
    ...
    public void test_getServerList() throws Exception {
        ...
        for (InetSocketAddress add : AddrUtil.getAddressList(CommonUtil.toList("localhost:11", "localhost:22"))) {
            N.println(add.toString());
        }

        N.println(AddrUtil.getAddressListFromUrls(CommonUtil.toList(new URL("https://www.google.com:443/"))));
