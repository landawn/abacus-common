...
public class FloatIteratorExTest extends TestBase {
    ...
    public void testNext() {
        FloatIteratorEx iter = FloatIteratorEx.of(1.5f, 2.5f);
        Assertions.assertEquals(Float.valueOf(1.5f), iter.next());
        Assertions.assertEquals(Float.valueOf(2.5f), iter.next());
        Assertions.assertFalse(iter.hasNext());
    }
    ...
    public void testSkip() {
        ...
        Assertions.assertEquals(3.0f, skipped.nextFloat());
        Assertions.assertEquals(4.0f, skipped.nextFloat());
        Assertions.assertEquals(5.0f, skipped.nextFloat());
    ...
    public void testLimit() {
        ...
        Assertions.assertEquals(1.0f, limited.nextFloat());
        Assertions.assertEquals(2.0f, limited.nextFloat());
        Assertions.assertEquals(3.0f, limited.nextFloat());
    ...
    public void testFilter() {
        FloatIteratorEx iter = FloatIteratorEx.of(1.0f, 2.0f, 3.0f, 4.0f, 5.0f);
        FloatIterator filtered = iter.filter(f -> f > 3.0f);

        Assertions.assertEquals(4.0f, filtered.nextFloat());
        Assertions.assertEquals(5.0f, filtered.nextFloat());
    ...
    public void testForEachRemaining() {
        FloatIteratorEx iter = FloatIteratorEx.of(1.1f, 2.2f, 3.3f);
        List<Float> collected = new ArrayList<>();
        iter.forEachRemaining((java.util.function.Consumer<? super Float>) collected::add);

        Assertions.assertEquals(3, collected.size());
        Assertions.assertEquals(1.1f, collected.get(0));
        Assertions.assertEquals(2.2f, collected.get(1));
        Assertions.assertEquals(3.3f, collected.get(2));
    }
