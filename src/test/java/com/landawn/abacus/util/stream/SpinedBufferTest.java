...
public class SpinedBufferTest extends TestBase {
    ...
    public void testForEach() {
        ...
        Assertions.assertEquals(20, collected.size());
        for (int i = 0; i < 20; i++) {
    ...
    @Test
    public void testOfIntLargeDataset() {
        SpinedBuffer.OfInt buffer = new SpinedBuffer.OfInt(1);
        int total = 1000;
        for (int i = 0; i < total; i++) {
            buffer.add(i);
        }
    ...
    @Test
    public void testOfLongLargeDataset() {
        SpinedBuffer.OfLong buffer = new SpinedBuffer.OfLong(1);
        int total = 1000;
    ...
    @Test
    public void testOfDoubleLargeDataset() {
        SpinedBuffer.OfDouble buffer = new SpinedBuffer.OfDouble(1);
        int total = 1000;
        for (int i = 0; i < total; i++) {
            buffer.add(i * 0.1);
        }
        ...
        DoubleIterator iter = buffer.iterator();
        for (int i = 0; i < total; i++) {
            Assertions.assertEquals(i * 0.1, iter.nextDouble(), 0.0001);
        }
    }
    ...
    public void testNullElements() {
        ...
        Assertions.assertEquals(3, buffer.size());
        Assertions.assertTrue(buffer.contains(null));
