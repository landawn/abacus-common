...
public class ComparatorsMapByKeyTest extends AbstractTest {
    ...
    public void test_comparingMapByKey() {
        ...
        CommonUtil.sort(maps, Comparators.<String, Map<String, Integer>> comparingMapByKey().reversed());
        N.println(maps);

        CommonUtil.sort(maps, Comparators.comparingMapByValue());
        N.println(maps);

        CommonUtil.sort(maps, Comparators.<Integer, Map<String, Integer>> comparingMapByValue().reversed());
        N.println(maps);
