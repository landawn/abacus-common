...
public class AclUser implements ExtendDirtyBasicPNL.AclUserPNL {
    ...
    public AclUser(long id, String gui, String name, String description, int status, Timestamp lastUpdateTime, Timestamp createdTime,
            List<AclGroup> groupList) {
        this();
    ...
    @Type("List<testfixtures.entity.extendDirty.basic.AclGroup>")
