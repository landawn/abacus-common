...
public class AccountContact implements HbasePNL.AccountContactPNL {
    ...
    public HBaseColumn<Long> accountId() {
        return N.isEmpty(accountId) ? HBaseColumn.emptyOf(long.class) : accountId.iterator().next();
    }
    ...
    public HBaseColumn<String> telephone() {
        return N.isEmpty(telephone) ? HBaseColumn.emptyOf(String.class) : telephone.iterator().next();
    }
    ...
    public HBaseColumn<String> city() {
        return N.isEmpty(city) ? HBaseColumn.emptyOf(String.class) : city.iterator().next();
    }
    ...
    public HBaseColumn<String> state() {
        return N.isEmpty(state) ? HBaseColumn.emptyOf(String.class) : state.iterator().next();
    }
    ...
    public HBaseColumn<String> zipCode() {
        return N.isEmpty(zipCode) ? HBaseColumn.emptyOf(String.class) : zipCode.iterator().next();
    }
    ...
    public HBaseColumn<Integer> status() {
        return N.isEmpty(status) ? HBaseColumn.emptyOf(int.class) : status.iterator().next();
    }
    ...
    public HBaseColumn<Timestamp> lastUpdateTime() {
        return N.isEmpty(lastUpdateTime) ? HBaseColumn.emptyOf(Timestamp.class) : lastUpdateTime.iterator().next();
    }
    ...
    public HBaseColumn<Timestamp> createdTime() {
        return N.isEmpty(createdTime) ? HBaseColumn.emptyOf(Timestamp.class) : createdTime.iterator().next();
    }
