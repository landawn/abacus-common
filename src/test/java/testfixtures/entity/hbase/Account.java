...
public class Account implements HbasePNL.AccountPNL {
    ...
    public HBaseColumn<String> gui() {
        return N.isEmpty(gui) ? HBaseColumn.emptyOf(String.class) : gui.values().iterator().next();
    }
    ...
    public HBaseColumn<String> emailAddress() {
        return N.isEmpty(emailAddress) ? HBaseColumn.emptyOf(String.class) : emailAddress.values().iterator().next();
    }
    ...
    @Type("testfixtures.entity.hbase.Name")
    public Name getName() {
        return name;
    }
    ...
    public HBaseColumn<Timestamp> lastUpdateTime() {
        return N.isEmpty(lastUpdateTime) ? HBaseColumn.emptyOf(Timestamp.class) : lastUpdateTime.values().iterator().next();
    }
    ...
    public HBaseColumn<Timestamp> createdTime() {
        return N.isEmpty(createdTime) ? HBaseColumn.emptyOf(Timestamp.class) : createdTime.values().iterator().next();
    }
    ...
    @Type("testfixtures.entity.hbase.AccountContact")
