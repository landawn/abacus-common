...
public class Name implements HbasePNL.NamePNL {
    ...
    public HBaseColumn<String> firstName() {
        return this.firstName == null ? HBaseColumn.emptyOf(String.class) : firstName;
    }
    ...
    public HBaseColumn<String> middleName() {
        return this.middleName == null ? HBaseColumn.emptyOf(String.class) : middleName;
    }
    ...
    public HBaseColumn<String> lastName() {
        return this.lastName == null ? HBaseColumn.emptyOf(String.class) : lastName;
    }
