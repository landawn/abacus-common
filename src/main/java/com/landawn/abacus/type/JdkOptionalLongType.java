...
public class JdkOptionalLongType extends AbstractOptionalType<OptionalLong> {
    ...
    /**
     * Compares two {@link OptionalLong} values using the ordering
     ...
     * @throws NumberFormatException if a non-{@code Number} column value is not a valid number token (a blank string
     *         included)
