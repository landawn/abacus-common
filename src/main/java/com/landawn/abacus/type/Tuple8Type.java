...
public class Tuple8Type<T1, T2, T3, T4, T5, T6, T7, T8> extends AbstractType<Tuple8<T1, T2, T3, T4, T5, T6, T7, T8>> {
    ...
    private final Class<Tuple8<T1, T2, T3, T4, T5, T6, T7, T8>> typeClass = (Class) Tuple8.class;
     ...
     */
    @Override
    public void write(Writer writer, Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> x) throws IOException {
        if (x == null) {
     ...
     */
    @Override
    public void writeCharacter(CharacterWriter writer, Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> x, SerializationConfig<?> config) throws IOException {
        if (x == null) {
            writer.write(NULL_CHAR_ARRAY);
        } else {
            try {
