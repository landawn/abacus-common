...
public class Tuple3Type<T1, T2, T3> extends AbstractType<Tuple3<T1, T2, T3>> {
     ...
     */
    @Override
    public void appendTo(Appendable appendable, Tuple3<T1, T2, T3> x) throws IOException {
        if (x == null) {
     ...
     */
    @Override
    public void writeCharacter(CharacterWriter writer, Tuple3<T1, T2, T3> x, JSONXMLSerializationConfig<?> config) throws IOException {
        if (x == null) {
