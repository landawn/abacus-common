...
public class Tuple3Type<T1, T2, T3> extends AbstractType<Tuple3<T1, T2, T3>> {
    ...
    private final Class<Tuple3<T1, T2, T3>> typeClass = (Class) Tuple3.class;
    ...
    Tuple3Type(String t1TypeName, String t2TypeName, String t3TypeName) {
        super(getTypeName(t1TypeName, t2TypeName, t3TypeName, false));

        this.declaringName = getTypeName(t1TypeName, t2TypeName, t3TypeName, true);
        ...
        this.parameterTypes = new Type[] { type1, type2, type3 };
    }
     ...
     */
    @Override
    public String stringOf(Tuple3<T1, T2, T3> x) {
    ...
    @Override
    public Tuple3<T1, T2, T3> valueOf(String str) {
     ...
     */
    @Override
    public void write(Writer writer, Tuple3<T1, T2, T3> x) throws IOException {
        if (x == null) {
     ...
     */
    @Override
    public void writeCharacter(CharacterWriter writer, Tuple3<T1, T2, T3> x, SerializationConfig<?> config) throws IOException {
        if (x == null) {
            writer.write(NULL_CHAR_ARRAY);
        } else {
            try {
     ...
     * @return
     */
    protected static String getTypeName(String t1TypeName, String t2TypeName, String t3TypeName, boolean isDeclaringName) {
        if (isDeclaringName) {
