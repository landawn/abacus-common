...
public class Tuple5Type<T1, T2, T3, T4, T5> extends AbstractType<Tuple5<T1, T2, T3, T4, T5>> {
    ...
    private final Class<Tuple5<T1, T2, T3, T4, T5>> typeClass = (Class) Tuple5.class;
     ...
     */
    @Override
    public void write(Writer writer, Tuple5<T1, T2, T3, T4, T5> x) throws IOException {
        if (x == null) {
     ...
     */
    @Override
    public void writeCharacter(CharacterWriter writer, Tuple5<T1, T2, T3, T4, T5> x, SerializationConfig<?> config) throws IOException {
        if (x == null) {
            writer.write(NULL_CHAR_ARRAY);
        } else {
            try {
