...
public class Tuple7Type<T1, T2, T3, T4, T5, T6, T7> extends AbstractTupleType<Tuple7<T1, T2, T3, T4, T5, T6, T7>> {
    ...
    Tuple7Type(final String t1TypeName, final String t2TypeName, final String t3TypeName, final String t4TypeName, final String t5TypeName,
            final String t6TypeName, final String t7TypeName) throws IllegalArgumentException {
    ...
    /**
     * Reconstructs a {@link Tuple7} from an already type-converted element array.
     * The array is expected to contain exactly seven elements matching the tuple's parameter types.
     *
     * @param converted the array of converted element values (must be of length 7)
     * @return a new {@code Tuple7} containing the seven elements in order
     * @throws NullPointerException if {@code converted} is {@code null}.
     * @throws ArrayIndexOutOfBoundsException if {@code converted} contains fewer than 7 elements.
     */
    @SuppressWarnings("unchecked")
    @Override
    protected Tuple7<T1, T2, T3, T4, T5, T6, T7> fromArray(final Object[] converted) throws NullPointerException, ArrayIndexOutOfBoundsException {
    ...
    protected static String getTypeName(final String t1TypeName, final String t2TypeName, final String t3TypeName, final String t4TypeName,
            final String t5TypeName, final String t6TypeName, final String t7TypeName, final boolean isDeclaringName) throws IllegalArgumentException {
        if (isDeclaringName) {
