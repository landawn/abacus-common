...
public class Tuple7Type<T1, T2, T3, T4, T5, T6, T7> extends AbstractType<Tuple7<T1, T2, T3, T4, T5, T6, T7>> {
    ...
    private final Class<Tuple7<T1, T2, T3, T4, T5, T6, T7>> typeClass = (Class) Tuple7.class;
     ...
     */
    @Override
    public void write(Writer writer, Tuple7<T1, T2, T3, T4, T5, T6, T7> x) throws IOException {
        if (x == null) {
     ...
     */
    @Override
    public void writeCharacter(CharacterWriter writer, Tuple7<T1, T2, T3, T4, T5, T6, T7> x, SerializationConfig<?> config) throws IOException {
        if (x == null) {
            writer.write(NULL_CHAR_ARRAY);
        } else {
            try {
