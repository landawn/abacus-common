...
public class Tuple9Type<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends AbstractType<Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> {
     ...
     */
    @Override
    public void appendTo(Appendable appendable, Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> x) throws IOException {
        if (x == null) {
     ...
     */
    @Override
    public void writeCharacter(CharacterWriter writer, Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> x, JSONXMLSerializationConfig<?> config) throws IOException {
        if (x == null) {
