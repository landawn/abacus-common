...
public class Tuple9Type<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends AbstractType<Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> {
    ...
    private final Class<Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> typeClass = (Class) Tuple9.class;
    ...
    Tuple9Type(String t1TypeName, String t2TypeName, String t3TypeName, String t4TypeName, String t5TypeName, String t6TypeName, String t7TypeName,
            String t8TypeName, String t9TypeName) {
        ...
        this.declaringName = getTypeName(t1TypeName, t2TypeName, t3TypeName, t4TypeName, t5TypeName, t6TypeName, t7TypeName, t8TypeName, t9TypeName, true);
        ...
        this.type9 = TypeFactory.getType(t9TypeName);
        this.parameterTypes = new Type[] { type1, type2, type3, type4, type5, type6, type7, type8, type9 };
    }
     ...
     */
    @Override
    public String stringOf(Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> x) {
     ...
     */
    @Override
    public void write(Writer writer, Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> x) throws IOException {
        if (x == null) {
     ...
     */
    @Override
    public void writeCharacter(CharacterWriter writer, Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> x, SerializationConfig<?> config) throws IOException {
        if (x == null) {
            writer.write(NULL_CHAR_ARRAY);
        } else {
            try {
    ...
    protected static String getTypeName(String t1TypeName, String t2TypeName, String t3TypeName, String t4TypeName, String t5TypeName, String t6TypeName,
            String t7TypeName, String t8TypeName, String t9TypeName, boolean isDeclaringName) {
        if (isDeclaringName) {
