...
public class MutableDoubleType extends NumberType<MutableDouble> {
     ...
     * @see #valueOf(Object)
     * @see #stringOf(MutableDouble)
     */
    @Override
    public MutableDouble valueOf(final String str) throws NumberFormatException {
     ...
     */
    @Override
    public MutableDouble get(final ResultSet rs, final int columnIndex) throws NullPointerException, SQLException {
     ...
     */
    @Override
    public MutableDouble get(final ResultSet rs, final String columnName) throws NullPointerException, SQLException {
     ...
     */
    @Override
    public void appendTo(final Appendable appendable, final MutableDouble x) throws NullPointerException, IOException {
        if (x == null) {
     ...
     */
    @Override
    public void serializeTo(final CharacterWriter writer, final MutableDouble x, final JsonXmlSerConfig<?> config) throws NullPointerException, IOException {
        if (x == null) {
