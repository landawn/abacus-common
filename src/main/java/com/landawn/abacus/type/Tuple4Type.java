...
public class Tuple4Type<T1, T2, T3, T4> extends AbstractType<Tuple4<T1, T2, T3, T4>> {
     ...
     */
    @Override
    public Class<Tuple4<T1, T2, T3, T4>> javaType() {
        return typeClass;
    }
    ...
    public Tuple4<T1, T2, T3, T4> valueOf(final String str) {
        ...
        if (a == null || a.length < 4) {
            throw new IllegalArgumentException("Invalid Tuple4 format. Expected array with at least 4 elements but got: " + str);
        }
     ...
     */
    @Override
    public void writeCharacter(final CharacterWriter writer, final Tuple4<T1, T2, T3, T4> x, final JsonXmlSerConfig<?> config) throws IOException {
        if (x == null) {
