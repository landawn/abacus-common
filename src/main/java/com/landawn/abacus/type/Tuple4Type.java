 ...
 * This class provides serialization and deserialization support for 4-element tuple instances
...
public class Tuple4Type<T1, T2, T3, T4> extends AbstractTupleType<Tuple4<T1, T2, T3, T4>> {
    ...
    Tuple4Type(final String t1TypeName, final String t2TypeName, final String t3TypeName, final String t4TypeName) throws IllegalArgumentException {
        super(getTypeName(t1TypeName, t2TypeName, t3TypeName, t4TypeName, false), getTypeName(t1TypeName, t2TypeName, t3TypeName, t4TypeName, true),
                (Class) Tuple4.class,
     ...
     * @throws ArrayIndexOutOfBoundsException if {@code converted} contains fewer than 4 elements.
     */
    @SuppressWarnings("unchecked")
    @Override
    protected Tuple4<T1, T2, T3, T4> fromArray(final Object[] converted) throws NullPointerException, ArrayIndexOutOfBoundsException {
        return Tuple.of((T1) converted[0], (T2) converted[1], (T3) converted[2], (T4) converted[3]);
    }
