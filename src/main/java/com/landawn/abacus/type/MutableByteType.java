...
public class MutableByteType extends NumberType<MutableByte> {
     ...
     */
    @Override
    public MutableByte valueOf(final String str) throws NumberFormatException, ArithmeticException {
     ...
     */
    @Override
    public MutableByte get(final ResultSet rs, final int columnIndex) throws NullPointerException, SQLException {
     ...
     */
    @Override
    public MutableByte get(final ResultSet rs, final String columnName) throws NullPointerException, SQLException {
     ...
     */
    @Override
    public void appendTo(final Appendable appendable, final MutableByte x) throws NullPointerException, IOException {
        if (x == null) {
     ...
     */
    @Override
    public void serializeTo(final CharacterWriter writer, final MutableByte x, final JsonXmlSerConfig<?> config) throws NullPointerException, IOException {
        if (x == null) {
