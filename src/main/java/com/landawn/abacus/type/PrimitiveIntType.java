 ...
 *
 * <p>The key distinction from {@code IntegerType} (which handles {@link Integer}) is the default value:
 * {@link #defaultValue()} returns {@code 0} (matching the JLS default for {@code int}),
