...
public final class DoubleType extends AbstractDoubleType {
     ...
     * @return the {@code Double} value of the column, or {@code null} if the column value is SQL {@code NULL}
    ...
    @MayReturnNull
    @Override
    public Double get(final ResultSet rs, final int columnIndex) throws NullPointerException, SQLException, NumberFormatException {
    ...
    @MayReturnNull
    @Override
    public Double get(final ResultSet rs, final String columnName) throws NullPointerException, SQLException, NumberFormatException {
