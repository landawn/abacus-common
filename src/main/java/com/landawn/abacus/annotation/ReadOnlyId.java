 ...
 * This annotation combines the semantics of {@link Id} and {@link ReadOnly}, indicating that the annotated element
 ...
 * <p><b>Behavior:</b></p>
 * <ul>
 *   <li>{@code INSERT} operations: The ID field is excluded, letting the database generate the value.</li>
 *   <li>{@code UPDATE} operations: The ID field is excluded, preventing accidental key changes.</li>
 *   <li>{@code SELECT} operations: The ID field is included normally for queries and lookups.</li>
 * </ul>
 *
 * <p><b>Usage patterns:</b></p>
 * <ul>
 *   <li>On fields: Marks a single field as a read-only identifier.</li>
 *   <li>On types: Can specify composite read-only keys via the {@link #value()} array.</li>
 * </ul>
 *
 ...
 * @Entity
 * @ReadOnlyId({"company_id", "department_id"})
