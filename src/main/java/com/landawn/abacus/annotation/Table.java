 ...
 * <ul>
 *   <li>If both {@code columnFields} and {@code nonColumnFields} are empty: all fields are mapped.</li>
 *   <li>If {@code columnFields} is specified: only listed fields are mapped.</li>
 *   <li>If {@code nonColumnFields} is specified: all fields except listed ones are mapped.</li>
 *   <li>{@code columnFields} takes precedence over {@code nonColumnFields} if both are specified.</li>
 * </ul>
 *
...
public @interface Table {
     ...
     * }</pre>
     *
     * @return an array of field names to include as columns, an empty array means no whitelist filtering
     */
     ...
     * {@code columnFields} takes precedence (whitelist wins over blacklist).</p>
     *
     * @return an array of field names to exclude from column mapping, an empty array means no blacklist filtering
     */
