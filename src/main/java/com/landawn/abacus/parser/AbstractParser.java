...
abstract class AbstractParser<SC extends SerializationConfig<?>, DC extends DeserializationConfig<?>> implements Parser<SC, DC> {
    ...
    static {
        mapOfCreatorAndConvertorForTargetType.put(ImmutableList.class,
                Tuple.<Function<Class<?>, Object>, Function<Object, Object>> of(new Function<Class<?>, Object>() {
                    @Override
        ...
        mapOfCreatorAndConvertorForTargetType.put(Object.class,
                Tuple.<Function<Class<?>, Object>, Function<Object, Object>> of(new Function<Class<?>, Object>() {
                    @Override
                    public Object apply(final Class<?> t) {
