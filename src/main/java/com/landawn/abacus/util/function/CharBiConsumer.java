...
public interface CharBiConsumer extends Throwables.CharBiConsumer<RuntimeException> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.CharBiConsumer} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.CharBiConsumer}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.CharBiConsumer}
     * @return a {@link Throwables.CharBiConsumer} view of this object
     */
