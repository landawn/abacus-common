...
public interface LongBiPredicate extends Throwables.LongBiPredicate<RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code LongBiPredicate} to a {@code Throwables.LongBiPredicate} that can throw a checked exception.
     ...
     * @return a {@code Throwables.LongBiPredicate} view of this predicate that can throw exceptions of type {@code E}
     */
