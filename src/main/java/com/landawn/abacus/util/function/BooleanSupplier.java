...
public interface BooleanSupplier extends Throwables.BooleanSupplier<RuntimeException>, java.util.function.BooleanSupplier { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.BooleanSupplier} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.BooleanSupplier}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.BooleanSupplier}
     * @return a {@link Throwables.BooleanSupplier} view of this object
     */
