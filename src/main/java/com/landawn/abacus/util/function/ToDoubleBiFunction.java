...
public interface ToDoubleBiFunction<T, U> extends Throwables.ToDoubleBiFunction<T, U, RuntimeException>, java.util.function.ToDoubleBiFunction<T, U> { //NOSONAR
    ...
    /**
     * Converts this {@code ToDoubleBiFunction} to a {@code Throwables.ToDoubleBiFunction} that can throw a checked exception.
     ...
     * @return a {@code Throwables.ToDoubleBiFunction} view of this function that can throw exceptions of type {@code E}
     */
