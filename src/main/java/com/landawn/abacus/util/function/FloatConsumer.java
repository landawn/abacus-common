...
public interface FloatConsumer extends Throwables.FloatConsumer<RuntimeException> { //NOSONAR
     ...
     */
    default FloatConsumer andThen(final FloatConsumer after) throws IllegalArgumentException {
    ...
    /**
     * Returns this object as a {@link Throwables.FloatConsumer} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.FloatConsumer}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.FloatConsumer}
     * @return a {@link Throwables.FloatConsumer} view of this object
     */
    default <E extends Throwable> Throwables.FloatConsumer<E> toThrowable() {
        return (Throwables.FloatConsumer<E>) this;
    }
}
