...
public interface IntTriPredicate extends Throwables.IntTriPredicate<RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code IntTriPredicate} to a {@code Throwables.IntTriPredicate} that can throw a checked exception.
     ...
     * @return a {@code Throwables.IntTriPredicate} view of this predicate that can throw exceptions of type {@code E}
     */
