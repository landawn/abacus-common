...
public interface ObjBiIntPredicate<T> extends Throwables.ObjBiIntPredicate<T, RuntimeException> { // NOSONAR
    ...
    /**
     * Converts this {@code ObjBiIntPredicate} to a {@code Throwables.ObjBiIntPredicate} that can throw a checked exception.
     * This method provides a way to use this predicate in contexts that require explicit exception handling.
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * ObjBiIntPredicate predicate = (...) -> { ... };
     ...
     * @return a {@code Throwables.ObjBiIntPredicate} view of this predicate that can throw exceptions of type {@code E}
     */
