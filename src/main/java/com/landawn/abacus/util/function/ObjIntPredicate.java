...
public interface ObjIntPredicate<T> extends Throwables.ObjIntPredicate<T, RuntimeException> { // NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.ObjIntPredicate} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.ObjIntPredicate}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.ObjIntPredicate}
     * @return a {@link Throwables.ObjIntPredicate} view of this object
     */
