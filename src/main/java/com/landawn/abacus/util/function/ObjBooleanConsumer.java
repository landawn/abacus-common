...
public interface ObjBooleanConsumer<T> extends Throwables.ObjBooleanConsumer<T, RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code ObjBooleanConsumer} to a {@code Throwables.ObjBooleanConsumer} that can throw a checked exception.
     ...
     * @return a {@code Throwables.ObjBooleanConsumer} view of this consumer that can throw exceptions of type {@code E}
     */
