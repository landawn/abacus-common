...
public interface CharFunction<R> extends Throwables.CharFunction<R, RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code CharFunction} to a {@code Throwables.CharFunction} that can throw a checked exception.
     ...
     * @return a {@code Throwables.CharFunction} view of this function that can throw exceptions of type {@code E}
     */
