...
public interface NFunction<T, R> extends Throwables.NFunction<T, R, RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code NFunction} to a {@code Throwables.NFunction} that can throw a checked exception.
     ...
     * @return a {@code Throwables.NFunction} view of this function that can throw exceptions of type {@code E}
     */
