...
public interface BiObjIntFunction<T, U, R> extends Throwables.BiObjIntFunction<T, U, R, RuntimeException> { //NOSONAR
     ...
     */
    default <V> BiObjIntFunction<T, U, V> andThen(final java.util.function.Function<? super R, ? extends V> after) throws IllegalArgumentException {
    ...
    /**
     * Returns this object as a {@link Throwables.BiObjIntFunction} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.BiObjIntFunction}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.BiObjIntFunction}
     * @return a {@link Throwables.BiObjIntFunction} view of this object
     */
