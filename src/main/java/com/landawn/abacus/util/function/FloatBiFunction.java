...
public interface FloatBiFunction<R> extends Throwables.FloatBiFunction<R, RuntimeException> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.FloatBiFunction} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.FloatBiFunction}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.FloatBiFunction}
     * @return a {@link Throwables.FloatBiFunction} view of this object
     */
