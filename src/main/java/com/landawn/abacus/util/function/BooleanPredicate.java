...
public interface BooleanPredicate extends Throwables.BooleanPredicate<RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code BooleanPredicate} to a {@code Throwables.BooleanPredicate} that can throw a checked exception.
     ...
     * @return a {@code Throwables.BooleanPredicate} view of this predicate that can throw exceptions of type {@code E}
     */
