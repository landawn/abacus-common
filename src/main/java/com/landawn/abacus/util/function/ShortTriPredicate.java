...
public interface ShortTriPredicate extends Throwables.ShortTriPredicate<RuntimeException> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.ShortTriPredicate} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.ShortTriPredicate}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.ShortTriPredicate}
     * @return a {@link Throwables.ShortTriPredicate} view of this object
     */
    default <E extends Throwable> Throwables.ShortTriPredicate<E> toThrowable() {
        return (Throwables.ShortTriPredicate<E>) this;
    }
}
