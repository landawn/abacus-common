...
public interface ShortTriPredicate extends Throwables.ShortTriPredicate<RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code ShortTriPredicate} to a {@code Throwables.ShortTriPredicate} that can throw a checked exception.
     * This method provides a way to use this predicate in contexts that require explicit exception handling.
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * ShortTriPredicate predicate = (...) -> { ... };
     ...
     * @return a {@code Throwables.ShortTriPredicate} view of this predicate that can throw exceptions of type {@code E}
     */
