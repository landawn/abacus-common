...
public interface ObjLongPredicate<T> extends Throwables.ObjLongPredicate<T, RuntimeException> { // NOSONAR
    ...
    /**
     * Converts this {@code ObjLongPredicate} to a {@code Throwables.ObjLongPredicate} that can throw a checked exception.
     * This method provides a way to use this predicate in contexts that require explicit exception handling.
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * ObjLongPredicate predicate = (...) -> { ... };
     ...
     * @return a {@code Throwables.ObjLongPredicate} view of this predicate that can throw exceptions of type {@code E}
     */
