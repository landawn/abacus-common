...
public interface IntObjPredicate<T> extends Throwables.IntObjPredicate<T, RuntimeException> { // NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.IntObjPredicate} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.IntObjPredicate}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.IntObjPredicate}
     * @return a {@link Throwables.IntObjPredicate} view of this object
     */
