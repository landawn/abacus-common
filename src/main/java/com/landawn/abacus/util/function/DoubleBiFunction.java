...
public interface DoubleBiFunction<R> extends Throwables.DoubleBiFunction<R, RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code DoubleBiFunction} to a {@code Throwables.DoubleBiFunction} that can throw a checked exception.
     ...
     * @return a {@code Throwables.DoubleBiFunction} view of this function that can throw exceptions of type {@code E}
     */
