...
public interface DoubleBiFunction<R> extends Throwables.DoubleBiFunction<R, RuntimeException> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.DoubleBiFunction} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.DoubleBiFunction}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.DoubleBiFunction}
     * @return a {@link Throwables.DoubleBiFunction} view of this object
     */
    default <E extends Throwable> Throwables.DoubleBiFunction<R, E> toThrowable() {
        return (Throwables.DoubleBiFunction<R, E>) this;
    }
}
