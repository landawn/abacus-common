...
public interface IntTriConsumer extends Throwables.IntTriConsumer<RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code IntTriConsumer} to a {@code Throwables.IntTriConsumer} that can throw a checked exception.
     * This method provides a way to use this consumer in contexts that require explicit exception handling.
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * IntTriConsumer consumer = (...) -> { ... };
     * var throwableConsumer = consumer.toThrowable();
     * // Can now be used in contexts that handle checked exceptions
     * }</pre>
     *
     * @param <E> the type of exception that the returned consumer can throw
     * @return a {@code Throwables.IntTriConsumer} view of this consumer that can throw exceptions of type {@code E}
     */
