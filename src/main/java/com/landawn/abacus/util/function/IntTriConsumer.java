...
public interface IntTriConsumer extends Throwables.IntTriConsumer<RuntimeException> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.IntTriConsumer} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.IntTriConsumer}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.IntTriConsumer}
     * @return a {@link Throwables.IntTriConsumer} view of this object
     */
    default <E extends Throwable> Throwables.IntTriConsumer<E> toThrowable() {
        return (Throwables.IntTriConsumer<E>) this;
    }
}
