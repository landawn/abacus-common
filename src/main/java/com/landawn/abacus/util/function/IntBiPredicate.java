...
public interface IntBiPredicate extends Throwables.IntBiPredicate<RuntimeException> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.IntBiPredicate} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.IntBiPredicate}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.IntBiPredicate}
     * @return a {@link Throwables.IntBiPredicate} view of this object
     */
    default <E extends Throwable> Throwables.IntBiPredicate<E> toThrowable() {
        return (Throwables.IntBiPredicate<E>) this;
    }
}
