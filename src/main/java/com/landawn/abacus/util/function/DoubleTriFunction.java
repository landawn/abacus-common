...
public interface DoubleTriFunction<R> extends Throwables.DoubleTriFunction<R, RuntimeException> { //NOSONAR
     ...
     */
    default <V> DoubleTriFunction<V> andThen(final java.util.function.Function<? super R, ? extends V> after) throws IllegalArgumentException {
    ...
    /**
     * Returns this object as a {@link Throwables.DoubleTriFunction} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.DoubleTriFunction}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.DoubleTriFunction}
     * @return a {@link Throwables.DoubleTriFunction} view of this object
     */
    default <E extends Throwable> Throwables.DoubleTriFunction<R, E> toThrowable() {
        return (Throwables.DoubleTriFunction<R, E>) this;
    }
}
