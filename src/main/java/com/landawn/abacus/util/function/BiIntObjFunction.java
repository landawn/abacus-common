...
public interface BiIntObjFunction<T, R> extends Throwables.BiIntObjFunction<T, R, RuntimeException> { //NOSONAR
     ...
     */
    default <V> BiIntObjFunction<T, V> andThen(final java.util.function.Function<? super R, ? extends V> after) throws IllegalArgumentException {
    ...
    /**
     * Returns this object as a {@link Throwables.BiIntObjFunction} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.BiIntObjFunction}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.BiIntObjFunction}
     * @return a {@link Throwables.BiIntObjFunction} view of this object
     */
