...
public interface DoubleUnaryOperator extends Throwables.DoubleUnaryOperator<RuntimeException>, java.util.function.DoubleUnaryOperator { //NOSONAR
    ...
    /**
     * Converts this {@code DoubleUnaryOperator} to a {@code Throwables.DoubleUnaryOperator} that can throw a checked exception.
     ...
     * @return a {@code Throwables.DoubleUnaryOperator} view of this operator that can throw exceptions of type {@code E}
     */
