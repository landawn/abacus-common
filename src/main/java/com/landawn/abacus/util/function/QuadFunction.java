...
public interface QuadFunction<A, B, C, D, R> extends Throwables.QuadFunction<A, B, C, D, R, RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code QuadFunction} to a {@code Throwables.QuadFunction} that can throw a checked exception.
     ...
     * @return a {@code Throwables.QuadFunction} view of this function that can throw exceptions of type {@code E}
     */
