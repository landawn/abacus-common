...
public interface CharTriPredicate extends Throwables.CharTriPredicate<RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code CharTriPredicate} to a {@code Throwables.CharTriPredicate} that can throw a checked exception.
     * This method provides a way to use this predicate in contexts that require explicit exception handling.
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * CharTriPredicate predicate = (...) -> { ... };
     ...
     * @return a {@code Throwables.CharTriPredicate} view of this predicate that can throw exceptions of type {@code E}
     */
