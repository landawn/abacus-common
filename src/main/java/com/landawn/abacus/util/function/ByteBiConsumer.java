...
public interface ByteBiConsumer extends Throwables.ByteBiConsumer<RuntimeException> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.ByteBiConsumer} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.ByteBiConsumer}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.ByteBiConsumer}
     * @return a {@link Throwables.ByteBiConsumer} view of this object
     */
    default <E extends Throwable> Throwables.ByteBiConsumer<E> toThrowable() {
        return (Throwables.ByteBiConsumer<E>) this;
    }
}
