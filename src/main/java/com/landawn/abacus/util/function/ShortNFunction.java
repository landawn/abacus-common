...
/**
 * Represents a function that accepts a variable number of {@code short}-valued arguments and produces a result.
...
public interface ShortNFunction<R> extends Throwables.ShortNFunction<R, RuntimeException> { //NOSONAR
     ...
     */
    @Override
    default <V> ShortNFunction<V> andThen(final java.util.function.Function<? super R, ? extends V> after) throws IllegalArgumentException {
    ...
    /**
     * Returns this object as a {@link Throwables.ShortNFunction} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.ShortNFunction}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.ShortNFunction}
     * @return a {@link Throwables.ShortNFunction} view of this object
     */
