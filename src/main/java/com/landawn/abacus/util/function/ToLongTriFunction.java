...
public interface ToLongTriFunction<A, B, C> extends Throwables.ToLongTriFunction<A, B, C, RuntimeException> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.ToLongTriFunction} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.ToLongTriFunction}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.ToLongTriFunction}
     * @return a {@link Throwables.ToLongTriFunction} view of this object
     */
    default <E extends Throwable> Throwables.ToLongTriFunction<A, B, C, E> toThrowable() {
        return (Throwables.ToLongTriFunction<A, B, C, E>) this;
    }
}
