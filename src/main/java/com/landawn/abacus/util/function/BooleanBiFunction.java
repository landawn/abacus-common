 ...
 * This is the primitive type specialization of {@link java.util.function.BiFunction} for {@code boolean}.
 *
...
public interface BooleanBiFunction<R> extends Throwables.BooleanBiFunction<R, RuntimeException> { //NOSONAR
     ...
     */
    default <V> BooleanBiFunction<V> andThen(final java.util.function.Function<? super R, ? extends V> after) throws IllegalArgumentException {
    ...
    /**
     * Returns this object as a {@link Throwables.BooleanBiFunction} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.BooleanBiFunction}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.BooleanBiFunction}
     * @return a {@link Throwables.BooleanBiFunction} view of this object
     */
    default <E extends Throwable> Throwables.BooleanBiFunction<R, E> toThrowable() {
        return (Throwables.BooleanBiFunction<R, E>) this;
    }
}
