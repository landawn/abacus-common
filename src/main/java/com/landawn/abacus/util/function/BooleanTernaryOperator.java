...
public interface BooleanTernaryOperator extends Throwables.BooleanTernaryOperator<RuntimeException> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.BooleanTernaryOperator} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.BooleanTernaryOperator}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.BooleanTernaryOperator}
     * @return a {@link Throwables.BooleanTernaryOperator} view of this object
     */
