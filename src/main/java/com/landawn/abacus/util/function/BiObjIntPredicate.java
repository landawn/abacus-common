...
public interface BiObjIntPredicate<T, U> extends Throwables.BiObjIntPredicate<T, U, RuntimeException> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.BiObjIntPredicate} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.BiObjIntPredicate}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.BiObjIntPredicate}
     * @return a {@link Throwables.BiObjIntPredicate} view of this object
     */
