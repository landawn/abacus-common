...
public interface FloatTriConsumer extends Throwables.FloatTriConsumer<RuntimeException> { //NOSONAR
     ...
     */
    default FloatTriConsumer andThen(final FloatTriConsumer after) throws IllegalArgumentException {
    ...
    /**
     * Returns this object as a {@link Throwables.FloatTriConsumer} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.FloatTriConsumer}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.FloatTriConsumer}
     * @return a {@link Throwables.FloatTriConsumer} view of this object
     */
