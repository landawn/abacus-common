...
public interface IntFunction<R> extends Throwables.IntFunction<R, RuntimeException>, java.util.function.IntFunction<R> { //NOSONAR
    ...
    /**
     * Converts this {@code IntFunction} to a {@code Throwables.IntFunction} that can throw a checked exception.
     ...
     * @return a {@code Throwables.IntFunction} view of this function that can throw exceptions of type {@code E}
     */
