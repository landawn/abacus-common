...
public interface IntFunction<R> extends Throwables.IntFunction<R, RuntimeException>, java.util.function.IntFunction<R> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.IntFunction} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.IntFunction}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.IntFunction}
     * @return a {@link Throwables.IntFunction} view of this object
     */
    default <E extends Throwable> Throwables.IntFunction<R, E> toThrowable() {
        return (Throwables.IntFunction<R, E>) this;
    }
}
