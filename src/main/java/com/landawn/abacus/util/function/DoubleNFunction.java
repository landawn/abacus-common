...
public interface DoubleNFunction<R> extends Throwables.DoubleNFunction<R, RuntimeException> { //NOSONAR
     ...
     */
    @Override
    default <V> DoubleNFunction<V> andThen(final java.util.function.Function<? super R, ? extends V> after) throws IllegalArgumentException {
    ...
    /**
     * Returns this object as a {@link Throwables.DoubleNFunction} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.DoubleNFunction}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.DoubleNFunction}
     * @return a {@link Throwables.DoubleNFunction} view of this object
     */
