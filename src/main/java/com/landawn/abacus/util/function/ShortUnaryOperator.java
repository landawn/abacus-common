...
public interface ShortUnaryOperator extends Throwables.ShortUnaryOperator<RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code ShortUnaryOperator} to a {@code Throwables.ShortUnaryOperator} that can throw a checked exception.
     ...
     * @return a {@code Throwables.ShortUnaryOperator} view of this operator that can throw exceptions of type {@code E}
     */
