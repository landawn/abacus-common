...
public interface ToByteFunction<T> extends Throwables.ToByteFunction<T, RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code ToByteFunction} to a {@code Throwables.ToByteFunction} that can throw a checked exception.
     ...
     * @return a {@code Throwables.ToByteFunction} view of this function that can throw exceptions of type {@code E}
     */
