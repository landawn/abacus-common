...
public interface CharBiPredicate extends Throwables.CharBiPredicate<RuntimeException> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.CharBiPredicate} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.CharBiPredicate}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.CharBiPredicate}
     * @return a {@link Throwables.CharBiPredicate} view of this object
     */
    default <E extends Throwable> Throwables.CharBiPredicate<E> toThrowable() {
        return (Throwables.CharBiPredicate<E>) this;
    }
}
