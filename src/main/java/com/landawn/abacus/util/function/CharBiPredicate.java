...
public interface CharBiPredicate extends Throwables.CharBiPredicate<RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code CharBiPredicate} to a {@code Throwables.CharBiPredicate} that can throw a checked exception.
     ...
     * @return a {@code Throwables.CharBiPredicate} view of this predicate that can throw exceptions of type {@code E}
     */
