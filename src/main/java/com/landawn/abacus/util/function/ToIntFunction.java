 ...
 * ToIntFunction, providing compatibility with both the abacus-common framework's error handling
...
public interface ToIntFunction<T> extends Throwables.ToIntFunction<T, RuntimeException>, java.util.function.ToIntFunction<T> { //NOSONAR
    ...
    /**
     * Converts this {@code ToIntFunction} to a {@code Throwables.ToIntFunction} that can throw a checked exception.
     ...
     * @return a {@code Throwables.ToIntFunction} view of this function that can throw exceptions of type {@code E}
     */
