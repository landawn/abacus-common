...
public interface LongBiConsumer extends Throwables.LongBiConsumer<RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code LongBiConsumer} to a {@code Throwables.LongBiConsumer} that can throw a checked exception.
     ...
     * @return a {@code Throwables.LongBiConsumer} view of this consumer that can throw exceptions of type {@code E}
     */
