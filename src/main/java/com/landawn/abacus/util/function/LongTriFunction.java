...
public interface LongTriFunction<R> extends Throwables.LongTriFunction<R, RuntimeException> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.LongTriFunction} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.LongTriFunction}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.LongTriFunction}
     * @return a {@link Throwables.LongTriFunction} view of this object
     */
    default <E extends Throwable> Throwables.LongTriFunction<R, E> toThrowable() {
        return (Throwables.LongTriFunction<R, E>) this;
    }
}
