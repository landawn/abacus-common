...
public interface LongBinaryOperator extends Throwables.LongBinaryOperator<RuntimeException>, java.util.function.LongBinaryOperator { //NOSONAR
    ...
    /**
     * Converts this {@code LongBinaryOperator} to a {@code Throwables.LongBinaryOperator} that can throw a checked exception.
     ...
     * @return a {@code Throwables.LongBinaryOperator} view of this operator that can throw exceptions of type {@code E}
     */
