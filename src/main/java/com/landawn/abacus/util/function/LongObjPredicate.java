...
public interface LongObjPredicate<T> extends Throwables.LongObjPredicate<T, RuntimeException> { // NOSONAR
     ...
     */
    default LongObjPredicate<T> and(final LongObjPredicate<? super T> other) {
     ...
     * @throws IllegalArgumentException if {@code other} is null
     */
    default LongObjPredicate<T> or(final LongObjPredicate<? super T> other) {
        N.checkArgNotNull(other, cs.other);
        return (t, u) -> test(t, u) || other.test(t, u);
    }

    /**
     * Returns this object as a {@link Throwables.LongObjPredicate} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.LongObjPredicate}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.LongObjPredicate}
     * @return a {@link Throwables.LongObjPredicate} view of this object
     */
