...
public interface ToShortFunction<T> extends Throwables.ToShortFunction<T, RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code ToShortFunction} to a {@code Throwables.ToShortFunction} that can throw a checked exception.
     ...
     * @return a {@code Throwables.ToShortFunction} view of this function that can throw exceptions of type {@code E}
     */
