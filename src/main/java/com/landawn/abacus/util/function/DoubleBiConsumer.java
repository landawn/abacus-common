...
public interface DoubleBiConsumer extends Throwables.DoubleBiConsumer<RuntimeException> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.DoubleBiConsumer} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.DoubleBiConsumer}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.DoubleBiConsumer}
     * @return a {@link Throwables.DoubleBiConsumer} view of this object
     */
