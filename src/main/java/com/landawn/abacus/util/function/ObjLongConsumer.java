...
public interface ObjLongConsumer<T> extends Throwables.ObjLongConsumer<T, RuntimeException>, java.util.function.ObjLongConsumer<T> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.ObjLongConsumer} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.ObjLongConsumer}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.ObjLongConsumer}
     * @return a {@link Throwables.ObjLongConsumer} view of this object
     */
    default <E extends Throwable> Throwables.ObjLongConsumer<T, E> toThrowable() {
        return (Throwables.ObjLongConsumer<T, E>) this;
    }
}
