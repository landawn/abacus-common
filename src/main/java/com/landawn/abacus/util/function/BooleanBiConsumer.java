...
public interface BooleanBiConsumer extends Throwables.BooleanBiConsumer<RuntimeException> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.BooleanBiConsumer} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.BooleanBiConsumer}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.BooleanBiConsumer}
     * @return a {@link Throwables.BooleanBiConsumer} view of this object
     */
    default <E extends Throwable> Throwables.BooleanBiConsumer<E> toThrowable() {
        return (Throwables.BooleanBiConsumer<E>) this;
    }
}
