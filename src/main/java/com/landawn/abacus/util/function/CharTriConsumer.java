...
public interface CharTriConsumer extends Throwables.CharTriConsumer<RuntimeException> { //NOSONAR
     ...
     */
    default CharTriConsumer andThen(final CharTriConsumer after) throws IllegalArgumentException {
    ...
    /**
     * Returns this object as a {@link Throwables.CharTriConsumer} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.CharTriConsumer}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.CharTriConsumer}
     * @return a {@link Throwables.CharTriConsumer} view of this object
     */
