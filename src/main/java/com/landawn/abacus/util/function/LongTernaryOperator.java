...
public interface LongTernaryOperator extends Throwables.LongTernaryOperator<RuntimeException> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.LongTernaryOperator} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.LongTernaryOperator}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.LongTernaryOperator}
     * @return a {@link Throwables.LongTernaryOperator} view of this object
     */
    default <E extends Throwable> Throwables.LongTernaryOperator<E> toThrowable() {
        return (Throwables.LongTernaryOperator<E>) this;
    }
}
