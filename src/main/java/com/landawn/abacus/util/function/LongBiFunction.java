...
public interface LongBiFunction<R> extends Throwables.LongBiFunction<R, RuntimeException> { //NOSONAR
     ...
     * <pre>{@code
     * LongBiFunction<Long> difference = (a, b) -> Math.absExact(Math.subtractExact(a, b));
    ...
    /**
     * Returns this object as a {@link Throwables.LongBiFunction} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.LongBiFunction}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.LongBiFunction}
     * @return a {@link Throwables.LongBiFunction} view of this object
     */
