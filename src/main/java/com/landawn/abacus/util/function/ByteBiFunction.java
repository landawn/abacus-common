...
public interface ByteBiFunction<R> extends Throwables.ByteBiFunction<R, RuntimeException> { //NOSONAR
     ...
     */
    default <V> ByteBiFunction<V> andThen(final java.util.function.Function<? super R, ? extends V> after) throws IllegalArgumentException {
    ...
    /**
     * Returns this object as a {@link Throwables.ByteBiFunction} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.ByteBiFunction}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.ByteBiFunction}
     * @return a {@link Throwables.ByteBiFunction} view of this object
     */
