...
public interface FloatBinaryOperator extends Throwables.FloatBinaryOperator<RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code FloatBinaryOperator} to a {@code Throwables.FloatBinaryOperator} that can throw a checked exception.
     ...
     * @return a {@code Throwables.FloatBinaryOperator} view of this operator that can throw exceptions of type {@code E}
     */
