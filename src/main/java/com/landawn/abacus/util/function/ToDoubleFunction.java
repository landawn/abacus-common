...
public interface ToDoubleFunction<T> extends Throwables.ToDoubleFunction<T, RuntimeException>, java.util.function.ToDoubleFunction<T> { //NOSONAR
    ...
    /**
     * Converts this {@code ToDoubleFunction} to a {@code Throwables.ToDoubleFunction} that can throw a checked exception.
     ...
     * @return a {@code Throwables.ToDoubleFunction} view of this function that can throw exceptions of type {@code E}
     */
