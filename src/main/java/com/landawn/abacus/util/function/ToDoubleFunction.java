...
public interface ToDoubleFunction<T> extends Throwables.ToDoubleFunction<T, RuntimeException>, java.util.function.ToDoubleFunction<T> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.ToDoubleFunction} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.ToDoubleFunction}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.ToDoubleFunction}
     * @return a {@link Throwables.ToDoubleFunction} view of this object
     */
    default <E extends Throwable> Throwables.ToDoubleFunction<T, E> toThrowable() {
        return (Throwables.ToDoubleFunction<T, E>) this;
    }
}
