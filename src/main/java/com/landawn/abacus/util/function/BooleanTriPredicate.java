...
public interface BooleanTriPredicate extends Throwables.BooleanTriPredicate<RuntimeException> { //NOSONAR
    ...
    /**
     * Converts this {@code BooleanTriPredicate} to a {@code Throwables.BooleanTriPredicate} that can throw a checked exception.
     * This method provides a way to use this predicate in contexts that require explicit exception handling.
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * BooleanTriPredicate predicate = (...) -> { ... };
     ...
     * @return a {@code Throwables.BooleanTriPredicate} view of this predicate that can throw exceptions of type {@code E}
     */
