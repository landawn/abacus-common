...
public interface BooleanTriPredicate extends Throwables.BooleanTriPredicate<RuntimeException> { //NOSONAR
    ...
    /**
     * Returns this object as a {@link Throwables.BooleanTriPredicate} view.
     *
     * <p>The returned object has the same behavior as this one. This method does not translate
     * exceptions or make the original implementation capable of throwing new checked exceptions; the
     * exception type parameter is for target-type compatibility with APIs that accept {@code Throwables.BooleanTriPredicate}.
     *
     * @param <E> the target exception type for compatibility with {@code Throwables.BooleanTriPredicate}
     * @return a {@link Throwables.BooleanTriPredicate} view of this object
     */
    default <E extends Throwable> Throwables.BooleanTriPredicate<E> toThrowable() {
        return (Throwables.BooleanTriPredicate<E>) this;
    }
}
