...
public class ExceptionalStream<T, E extends Exception> implements Closeable, Immutable {
    ...
    private static final LongSupplier sysTimeGetter = () -> System.currentTimeMillis();

    private Throwables.Function<List<T>, Stream<T>, E> listToStreamMapper() {
    ...
    @Beta
    @IntermediateOp
    public ExceptionalStream<Stream<T>, E> window(final Duration duration) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public ExceptionalStream<Stream<T>, E> window(final Duration duration, final LongSupplier startTime) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public ExceptionalStream<List<T>, E> windowToList(final Duration duration) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public ExceptionalStream<Set<T>, E> windowToSet(final Duration duration) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public <C extends Collection<T>> ExceptionalStream<C, E> window(final Duration duration, final Supplier<? extends C> collectionSupplier) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public <C extends Collection<T>> ExceptionalStream<C, E> window(final Duration duration, final LongSupplier startTime,
    ...
    @Beta
    @IntermediateOp
    public <A, R> ExceptionalStream<R, E> window(Duration duration, Collector<? super T, A, R> collector) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public <A, R> ExceptionalStream<R, E> window(Duration duration, final LongSupplier startTime, Collector<? super T, A, R> collector) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public ExceptionalStream<Stream<T>, E> window(final Duration duration, final long incrementInMillis) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public ExceptionalStream<Stream<T>, E> window(final Duration duration, final long incrementInMillis, final LongSupplier startTime) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public ExceptionalStream<List<T>, E> windowToList(final Duration duration, final long incrementInMillis) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public ExceptionalStream<Set<T>, E> windowToSet(final Duration duration, final long incrementInMillis) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public <C extends Collection<T>> ExceptionalStream<C, E> window(final Duration duration, final long incrementInMillis,
            final Supplier<? extends C> collectionSupplier) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public <C extends Collection<T>> ExceptionalStream<C, E> window(final Duration duration, final long incrementInMillis, final LongSupplier startTime,
            final Supplier<? extends C> collectionSupplier) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public <A, R> ExceptionalStream<R, E> window(final Duration duration, final long incrementInMillis, final Collector<? super T, A, R> collector) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public <A, R> ExceptionalStream<R, E> window(final Duration duration, final long incrementInMillis, final LongSupplier startTime,
            final Collector<? super T, A, R> collector) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public ExceptionalStream<Stream<T>, E> window(final int maxWindowSize, final Duration maxDuration) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public ExceptionalStream<Stream<T>, E> window(final int maxWindowSize, final Duration maxDuration, final LongSupplier startTime) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public <C extends Collection<T>> ExceptionalStream<C, E> window(final int maxWindowSize, final Duration maxDuration,
            final Supplier<? extends C> collectionSupplier) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public <C extends Collection<T>> ExceptionalStream<C, E> window(final int maxWindowSize, final Duration maxDuration, final LongSupplier startTime,
            final Supplier<? extends C> collectionSupplier) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public <A, R> ExceptionalStream<R, E> window(final int maxWindowSize, final Duration maxDuration, Collector<? super T, A, R> collector) {
        assertNotClosed();
    ...
    @Beta
    @IntermediateOp
    public <A, R> ExceptionalStream<R, E> window(final int maxWindowSize, final Duration maxDuration, final LongSupplier startTime,
            final Collector<? super T, A, R> collector) {
        assertNotClosed();
    ...
    public <U, R> ExceptionalStream<R, E> crossJoin(final Collection<? extends U> b, final Throwables.BiFunction<? super T, ? super U, R, ? extends E> func) {
        ...
        return flatMap(t -> ExceptionalStream.<U, E> of(b).map(u -> func.apply(t, u)));
    }
    ...
    public <U, R> ExceptionalStream<R, E> crossJoin(final ExceptionalStream<U, ? extends E> b,
        ...
        return flatMap(new Throwables.Function<T, ExceptionalStream<R, E>, E>() {
            ...
            public ExceptionalStream<R, E> apply(final T t) throws E {
                ...
                return ExceptionalStream.<U, E> of(c).map(u -> func.apply(t, u));
            }
    ...
    public <U, K, R> ExceptionalStream<R, E> innerJoin(final Collection<? extends U> b,
        ...
        return flatMap(new Throwables.Function<T, ExceptionalStream<R, E>, E>() {
            ...
            public ExceptionalStream<R, E> apply(final T t) throws E {
                ...
                return ExceptionalStream.<U, E> of(rightKeyMap.get(leftKeyMapper.apply(t))).map(u -> func.apply(t, u));
            }
        });
    }
    ...
    public <U, R> ExceptionalStream<R, E> innerJoin(final Collection<? extends U> b, final Throwables.BiPredicate<? super T, ? super U, ? extends E> predicate,
        ...
        return flatMap(t -> ExceptionalStream.<U, E> of(b).filter(u -> predicate.test(t, u)).map(u -> func.apply(t, u)));
    }
    ...
    public <U, K, R> ExceptionalStream<R, E> fullJoin(final Collection<? extends U> b,
        ...
        return flatMap(new Throwables.Function<T, ExceptionalStream<R, E>, E>() {
            ...
            public ExceptionalStream<R, E> apply(final T t) throws E {
                ...
                return N.isNullOrEmpty(values) ? ExceptionalStream.of(func.apply(t, (U) null)) : ExceptionalStream.<U, E> of(values).map(u -> {
                    joinedRights.put(u, u);

                    return func.apply(t, u);
                });
            }
        }).append(ExceptionalStream.<U, E> of(b).filter(u -> !joinedRights.containsKey(u)).map(u -> func.apply((T) null, u)));
    }

    @SuppressWarnings("rawtypes")
    private static Throwables.Function HOLDER_VALUE_GETTER;

    static {
        final Throwables.Function<Holder<Object>, Object, Exception> func = t -> t.value();
    ...
    public <U, R> ExceptionalStream<R, E> fullJoin(final Collection<? extends U> b, final Throwables.BiPredicate<? super T, ? super U, ? extends E> predicate,
        ...
        return flatMap(t -> ExceptionalStream.<U, E> of(b).filter(u -> predicate.test(t, u)).map(u -> {
            joinedRights.put(u, u);
        ...
        return flatMap(new Throwables.Function<T, ExceptionalStream<R, E>, E>() {
            ...
            public ExceptionalStream<R, E> apply(final T t) throws E {
                ...
                return N.isNullOrEmpty(values) ? ExceptionalStream.<R, E> of(func.apply(t, (U) null))
                        : ExceptionalStream.<U, E> of(values).map(u -> func.apply(t, u));
            }
        });
    }
    ...
    public <U, R> ExceptionalStream<R, E> leftJoin(final Collection<? extends U> b, final Throwables.BiPredicate<? super T, ? super U, ? extends E> predicate,
        ...
        return flatMap(t -> ExceptionalStream.<U, E> of(b)
    ...
    public <U, K, R> ExceptionalStream<R, E> rightJoin(final Collection<? extends U> b,
        ...
        return flatMap(new Throwables.Function<T, ExceptionalStream<R, E>, E>() {
            ...
            public ExceptionalStream<R, E> apply(final T t) throws E {
                ...
                return ExceptionalStream.<U, E> of(rightKeyMap.get(leftKeyMapper.apply(t))).map(u -> {
                    joinedRights.put(u, u);
    ...
    public <U, A, D, R> ExceptionalStream<R, E> joinByRange(final Iterator<U> b, final Throwables.BiPredicate<? super T, ? super U, ? extends E> predicate,
        ...
        final Throwables.Supplier<ExceptionalStream<R, E>, E> tmp = () -> nextValueHolder.value() == none ? ExceptionalStream.<R, E> empty()
                : mapperForUnJoinedEelements.apply(Iterators.concat(ObjIterator.of(nextValueHolder.value()), b));

        return map(mapper).append(ExceptionalStream.defer(tmp));
    }
    ...
    public <U, A, D, R> ExceptionalStream<R, E> joinByRange(final ExceptionalStream<U, ? extends E> b,
        ...
        return map(mapper).append(ExceptionalStream.defer(tmp)).onClose(newCloseHandler(b));
    }
    ...
    public <U, B extends Iterator<U>, R> ExceptionalStream<R, E> join(final B b, final Throwables.BiFunction<? super T, ? super B, R, ? extends E> joinFunc,
        ...
        Throwables.Supplier<? extends ExceptionalStream<R, E>, E> supplier = () -> mapperForUnJoinedEelements.apply(b);

        return map(mapper).append(ExceptionalStream.<R, E> defer(supplier));
    }
    ...
    public <U, R> ExceptionalStream<R, E> join(final ExceptionalStream<U, ? extends E> b,
        ...
        final Throwables.Supplier<? extends ExceptionalStream<R, E>, E> supplier = () -> mapperForUnJoinedEelements.apply(iter);

        return map(mapper).append(ExceptionalStream.defer(supplier)).onClose(newCloseHandler(b));
    }
