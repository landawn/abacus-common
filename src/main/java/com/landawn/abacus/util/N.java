...
public final class N extends CommonUtil {
     ...
     */
    public static int occurrencesOf(final Collection<?> c, final Object valueToFind) {
        if (isNullOrEmpty(c)) {
            return 0;
        }
     ...
     * @return
     */
    public static <T extends Comparable<? super T>> List<T> maxAll(final Collection<? extends T> c) {
     ...
     * @return
     */
    public static <T> List<T> maxAll(final Collection<? extends T> c, Comparator<? super T> cmp) {
        if (isNullOrEmpty(c)) {
            return new ArrayList<>();
        }
    ...
    public static <T, E extends Exception> double averageInt(final T[] a, final int fromIndex, final int toIndex,
        ...
        return ((double) N.sumInt(a, fromIndex, toIndex, func)) / (toIndex - fromIndex);
    }
     ...
     * @return
     */
    public static <T extends Number> double averageInt(final Collection<? extends T> c) {
     ...
     * @throws E the e
     */
    public static <T, E extends Exception> double averageInt(final Collection<? extends T> c, final Throwables.ToIntFunction<? super T, E> func) throws E {
        if (N.isNullOrEmpty(c)) {
            return 0d;
        }

        return ((double) N.sumInt(c, func)) / c.size();
    }
    ...
    public static <T, E extends Exception> double averageInt(final Collection<? extends T> c, final int fromIndex, final int toIndex,
        ...
        return ((double) N.sumInt(c, fromIndex, toIndex, func)) / (toIndex - fromIndex);
    }
     ...
     * @return
     */
    public static <T extends Number> double averageLong(final Collection<? extends T> c) {
     ...
     * @throws E the e
     */
    public static <T, E extends Exception> double averageLong(final Collection<? extends T> c, final Throwables.ToLongFunction<? super T, E> func) throws E {
        if (N.isNullOrEmpty(c)) {
            return 0d;
        }

        return ((double) N.sumLong(c, func)) / c.size();
    }
     ...
     */
    public static <T extends Number> double averageDouble(final Collection<? extends T> c) {
     ...
     */
    public static <T, E extends Exception> double averageDouble(final Collection<? extends T> c, final Throwables.ToDoubleFunction<? super T, E> func)
            throws E {
        if (N.isNullOrEmpty(c)) {
            return 0d;
        }
     ...
     * @throws E2 the e2
     */
    public static <T, T2, R, E extends Exception, E2 extends Exception> List<R> flatMap(final Collection<? extends T> c,
            final Throwables.Function<? super T, ? extends Collection<? extends T2>, E> func,
            final Throwables.Function<? super T2, ? extends Collection<? extends R>, E2> func2) throws E, E2 {
    ...
    */
    ...
    public static <T, C extends Collection<T>, E extends Exception> C distinctBy(final Collection<? extends T> c,
        ...
        final C result = supplier.get();
        final Set<Object> set = newHashSet(N.size(c) / 2 + 1);
    ...
    public static <T, E extends Exception> boolean allMatch(final Iterator<? extends T> iter, final Throwables.Predicate<? super T, E> filter) throws E {
        ...
        while (iter.hasNext()) {
            if (filter.test(iter.next()) == false) {
                return false;
            }
        }
    ...
    */
    ...
    public static <T, C extends Collection<T>> C merge(final Collection<? extends Collection<? extends T>> c,
        ...
        final Supplier<? extends C> tmp = new Supplier<C>() {
            @Override
            public C get() {
                return supplier.apply(totalCount);
            }
        };
    ...
    //     * @param unzip the second parameter is an output parameter.
    //     * @return
    //     * @see {@code Iterators.unzipp(Iterator, BiConsumer)}
    //     */
