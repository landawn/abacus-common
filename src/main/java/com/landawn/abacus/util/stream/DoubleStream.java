...
public abstract class DoubleStream
    ...
    //     *
    //     * @param stream the java.util.stream.DoubleStream to convert
    //     * @return a new DoubleStream containing the same elements
    //     * @deprecated Use {@link #from(java.util.stream.DoubleStream)} instead
    //     */
    //    @Deprecated
    //    public static DoubleStream of(final java.util.stream.DoubleStream stream) { // Should the name be from?
    //        return from(stream);
    //    }
     ...
     * }</pre>
     *
     * @param streams the collection of DoubleStreams to concatenate
     * @return a DoubleStream containing all elements from the input streams in order
    ...
    public static DoubleStream concat(final Collection<? extends DoubleStream> streams) {
        return N.isEmpty(streams) ? empty() : new IteratorDoubleStream(new DoubleIteratorEx() { //NOSONAR
            private final Iterator<? extends DoubleStream> iterators = streams.iterator();
     ...
     *
     * @param streams the collection of double streams to zip
     ...
     * }</pre>
     *
     * @param streams the collection of DoubleStreams to merge
     * @param nextSelector a function that determines which element should be selected next.
     *                     Returns MergeResult.TAKE_FIRST to select the first parameter, otherwise selects the second
     * @return a DoubleStream containing the merged elements
