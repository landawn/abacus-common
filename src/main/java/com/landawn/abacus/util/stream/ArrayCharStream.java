...
class ArrayCharStream extends AbstractCharStream {
    ...
    public Set<Character> toSet() {
        ...
        try {
            final Set<Character> result = N.newHashSet(N.initHashCapacity(toIndex - fromIndex));
    ...
    @Override
    public <E extends Exception> OrElse acceptIfNotEmpty(Try.Consumer<? super CharStream, E> action) throws E {
        try {
            if (fromIndex < toIndex) {
                action.accept(this);
