...
/**
 * A parallel implementation of FloatStream backed by an array that enables concurrent processing
 * of float elements across multiple threads. This class extends ArrayFloatStream and overrides
 ...
 * <pre>{@code
 * // Create a parallel float stream
 * float[] largeFloatArray = { 1.0f, -2.0f, 3.0f };
 * FloatStream stream = FloatStream.of(largeFloatArray).parallel();
 *
...
final class ParallelArrayFloatStream extends ArrayFloatStream {
    ...
    /**
     * Constructs a ParallelArrayFloatStream with the specified configuration for parallel processing.
     * This constructor initializes all parameters for controlling parallel execution behavior.
     *
     * @param values the float array to stream; it is used directly, not copied, so callers must not mutate it afterwards
     ...
     */
    ParallelArrayFloatStream(final float[] values, final int fromIndex, final int toIndex, final boolean sorted, final int maxThreadNum,
     ...
     * @return a new parallel {@code FloatStream} of matching elements
     ...
     *
     * @param predicate a non-interfering, stateless predicate to apply to each element
     * @return a new parallel {@code FloatStream} of the elements selected by the parallel {@code takeWhile} operation
     * @throws IllegalStateException if the stream is already closed
     * @throws IllegalArgumentException if {@code predicate} is {@code null}.
     */
    @Override
     ...
     *
     * @param predicate a non-interfering, stateless predicate to apply to each element
     * @return a new parallel {@code FloatStream} of the elements selected by the parallel {@code dropWhile} operation
     * @throws IllegalStateException if the stream is already closed
     * @throws IllegalArgumentException if {@code predicate} is {@code null}.
     */
    @Override
     ...
     * elements, flat-maps collections, and unboxes back to floats.
     *
     * @param mapper a non-interfering, stateless function that returns a {@code Collection<Float>} for each element
     * @return a new parallel {@code FloatStream} of the flattened collection contents
     * @throws IllegalStateException if the stream is already closed
     * @throws IllegalArgumentException if {@code mapper} is {@code null}.
     */
    @Override
    ...
    /**
     * Returns a parallel stream consisting of the results of replacing each element with the
     * contents of the mapped float array. If the stream can be processed sequentially, delegates
     * to the sequential {@code flatMapArray} wrapped in a parallel iterator stream; otherwise
     * boxes elements and flat-maps using {@code FloatStream.of(array)}.
     *
     * @param mapper a non-interfering, stateless function that returns a {@code float[]} for each element
     * @return a new parallel {@code FloatStream} of the flattened array contents
     * @throws IllegalStateException if the stream is already closed
     * @throws IllegalArgumentException if {@code mapper} is {@code null}.
     */
    @Override
     ...
     * the result is mapped back to floats. This method is primarily used for debugging.
     *
     ...
     * @return a new parallel {@code FloatStream} with the side-effecting action attached
     * @throws IllegalStateException if the stream is already closed
     ...
     * function, returning an {@code OptionalFloat} with the result, or an empty optional if the
     ...
     *
     * @param accumulator an associative, non-interfering, stateless function for combining two values
     * @return an {@code OptionalFloat} with the reduction result, or empty if the stream has no elements
     * @throws IllegalStateException if the stream is already closed
     * @throws IllegalArgumentException if {@code accumulator} is {@code null}.
     */
    @Override
    ...
    /**
     * Returns an {@code OptionalFloat} with the first element (in encounter order) matching the
     ...
     *
     * <p>Returns an empty {@code OptionalFloat} if no element matches.
     *
     * @param <E> the type of exception the predicate may throw
     * @param predicate a non-interfering, stateless predicate to apply to elements
     * @return an {@code OptionalFloat} with the first matching element, or empty if none match
     * @throws IllegalStateException if the stream is already closed
     * @throws IllegalArgumentException if {@code predicate} is {@code null}.
     * @throws E if the predicate throws an exception
     */
    ...
    /**
     * Returns an {@code OptionalFloat} with any element matching the predicate, evaluated in
     ...
     * @param <E> the type of exception the predicate may throw
     * @param predicate a non-interfering, stateless predicate to apply to elements
     * @return an {@code OptionalFloat} with any matching element, or empty if none match
     * @throws IllegalStateException if the stream is already closed
     * @throws IllegalArgumentException if {@code predicate} is {@code null}.
     * @throws E if the predicate throws an exception
     */
    @Override
    public <E extends Exception> OptionalFloat findAny(final Throwables.FloatPredicate<E> predicate) throws IllegalStateException, IllegalArgumentException, E {
        assertNotClosed();
    ...
    /**
     * Returns an {@code OptionalFloat} with the last element (in encounter order) matching the
     ...
     * @param <E> the type of exception the predicate may throw
     * @param predicate a non-interfering, stateless predicate to apply to elements
     * @return an {@code OptionalFloat} with the last matching element, or empty if none match
     * @throws IllegalStateException if the stream is already closed
     * @throws IllegalArgumentException if {@code predicate} is {@code null}.
     * @throws E if the predicate throws an exception
     */
     ...
     * @return a new parallel {@code FloatStream} of zipped results
     *
     ...
     */
    @Override
    public FloatStream zipWith(final FloatStream b, final FloatBinaryOperator zipFunction) throws IllegalStateException, IllegalArgumentException {
        assertNotClosed();
        ...
        return new ParallelIteratorFloatStream(Stream.parallelZip(boxed(), b.boxed(), zipFunction::applyAsFloat, maxThreadNum, asyncExecutor), false,
    ...
    public FloatStream zipWith(final FloatStream b, final FloatStream c, final FloatTernaryOperator zipFunction)
        ...
        return new ParallelIteratorFloatStream(Stream.parallelZip(boxed(), b.boxed(), c.boxed(), zipFunction::applyAsFloat, maxThreadNum, asyncExecutor), false,
                maxThreadNum, splitStrategy, asyncExecutor, cancelUncompletedThreads, null);
    }
     ...
     * stream {@code b} is exhausted. If the stream can be processed sequentially, uses sequential
     * zip; otherwise uses {@code Stream.parallelZip} for concurrent element pairing.
     *
     * @param b the second stream to zip with
     ...
     * @return a new parallel {@code FloatStream} of zipped results, with length equal to the longer stream
     *
     * @throws IllegalStateException if this stream or a source stream is already closed
     * @throws IllegalArgumentException if {@code b} or {@code zipFunction} is {@code null}
     */
    ...
    public FloatStream zipWith(final FloatStream b, final float valueForNoneA, final float valueForNoneB, final FloatBinaryOperator zipFunction)
        ...
        return new ParallelIteratorFloatStream(
                Stream.parallelZip(boxed(), b.boxed(), valueForNoneA, valueForNoneB, zipFunction::applyAsFloat, maxThreadNum, asyncExecutor), false,
                maxThreadNum, splitStrategy, asyncExecutor, cancelUncompletedThreads, null);
    }
     ...
     * elements, with padding values used when any stream is exhausted. If the stream can be processed
     * sequentially, uses sequential zip; otherwise uses {@code Stream.parallelZip} for concurrent
     * element pairing.
     *
     * @param b the second stream to zip with
     ...
     * @param zipFunction a function applied to corresponding (possibly padded) elements
     * @return a new parallel {@code FloatStream} of zipped results, with length equal to the longest stream
     *
     * @throws IllegalStateException if this stream or a source stream is already closed
     * @throws IllegalArgumentException if {@code b}, {@code c}, or {@code zipFunction} is {@code null}
     */
    ...
    public FloatStream zipWith(final FloatStream b, final FloatStream c, final float valueForNoneA, final float valueForNoneB, final float valueForNoneC,
            final FloatTernaryOperator zipFunction) throws IllegalStateException, IllegalArgumentException {
        assertNotClosed();
        ...
        return new ParallelIteratorFloatStream(Stream.parallelZip(boxed(), b.boxed(), c.boxed(), valueForNoneA, valueForNoneB, valueForNoneC,
                zipFunction::applyAsFloat, maxThreadNum, asyncExecutor), false, maxThreadNum, splitStrategy, asyncExecutor, cancelUncompletedThreads, null);
    }
    ...
    /**
     * Returns a sequential {@code FloatStream} view of this parallel stream backed by the same
     ...
     *
     * @return a sequential {@code FloatStream} over the same elements
     * @throws IllegalStateException if the stream is already closed
     */
    @Override
    public FloatStream sequential() throws IllegalStateException {
        ...
        if (tmp == null) {
            synchronized (this) {
                tmp = sequential;
                if (tmp == null) {
                    tmp = new ArrayFloatStream(elements, fromIndex, toIndex, isSorted(), closeHandlersForNewStream());
                    sequential = tmp;
                }
            }
        }
    ...
    /**
     * Returns the {@link BaseStream.SplitStrategy} used to divide work among threads.
     *
     * @return the split strategy used to divide work among threads
     */
    @Override
