 ...
 *
 * <p>Arithmetic methods use ordinary Java {@code long} arithmetic; overflow and underflow
...
public final class MutableLong extends Number implements Comparable<MutableLong>, Mutable {
     ...
     */
    public <E extends Exception> boolean setIf(final Throwables.LongPredicate<E> predicate, final long newValue) throws IllegalArgumentException, E {
     ...
     */
    @Override
    public int compareTo(final MutableLong other) throws NullPointerException {
