...
public abstract class Wrapper<T> implements Immutable {
     ...
     * @param hashFunction the function to calculate the hash code of the wrapped value; must be
     * consistent with {@code equalsFunction}.
     * @param equalsFunction the function to compare the wrapped value with other objects; must
     * implement symmetric/transitive equality.
     ...
     * @throws IllegalArgumentException if any of {@code hashFunction}, {@code equalsFunction},
     *         {@code toStringFunction} is {@code null}.
     */
    public static <T> Wrapper<T> of(final T value, final ToIntFunction<? super T> hashFunction, final BiPredicate<? super T, ? super T> equalsFunction,
