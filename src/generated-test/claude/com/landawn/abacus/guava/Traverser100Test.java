...
public class Traverser100Test extends TestBase {
    ...
    // Test node class for tree/graph traversal
    ...
    // Test node class for graph traversal
    ...
    public void testFILES_BreadthFirst() throws IOException {
        ...
        Traverser.FILES.breadthFirst(rootDir)
    ...
    public void testFILES_DepthFirstPreOrder() throws IOException {
        ...
        List<String> fileNames = new ArrayList<>();
        Traverser.FILES.depthFirstPreOrder(rootDir)
            .forEach(file -> fileNames.add(file.getName()));
    ...
    public void testFILES_DepthFirstPostOrder() throws IOException {
        ...
        List<String> fileNames = new ArrayList<>();
        Traverser.FILES.depthFirstPostOrder(rootDir)
            .forEach(file -> fileNames.add(file.getName()));
        
        // In post-order, subdirectory should come before parent
    ...
    public void testFILES_NonExistentFile() {
        ...
        Traverser.FILES.breadthFirst(nonExistent)
            .forEach(files::add);
    ...
    public void testFILES_EmptyDirectory() throws IOException {
        ...
        List<File> files = new ArrayList<>();
        Traverser.FILES.breadthFirst(emptyDir)
            .forEach(files::add);
    ...
    public void testStreamOperations_Filter() {
        ...
        List<String> result = new ArrayList<>();
        traverser.breadthFirst(root)
            .filter(node -> node.name.compareTo("C") > 0)
            .forEach(node -> result.add(node.name));
    ...
    // Helper method to create a simple tree structure
    ...
    // Helper method to create a larger tree for testing limits
