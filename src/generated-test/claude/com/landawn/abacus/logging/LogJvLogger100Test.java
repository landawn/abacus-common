...
public class LogJvLogger100Test extends TestBase {
    ...
    public void testIsEnabledMethods() {
        ...
        assertDoesNotThrow(() -> {
            ...
            // At least one level should be enabled in a typical configuration
    ...
    public void testMultipleLoggerInstances() {
        ...
        Log4Jv2Logger logger3 = new Log4Jv2Logger("test.log4j2.one"); // Same name as logger1
    ...
    public void testLoggingAtDisabledLevels() {
        ...
        // Even if levels are disabled, logging methods should not throw exceptions
        assertDoesNotThrow(() -> {
            // These may or may not actually log depending on configuration
