...
public class ObjIterator100Test extends TestBase {
    ...
    public void testOf_ArrayRange_InvalidIndices() {
        ...
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> 
            ObjIterator.of(array, -1, 2));
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> 
            ObjIterator.of(array, 0, 4));
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> 
            ObjIterator.of(array, 2, 1));
    }
    ...
    public void testDefer() {
        ...
        Assertions.assertFalse(supplierCalled[0]); // Not called yet
        
        Assertions.assertTrue(iter.hasNext());
        Assertions.assertTrue(supplierCalled[0]); // Called on first hasNext
    ...
    public void testGenerate_InfiniteSupplier() {
        ...
        Assertions.assertEquals(2, iter.next());
        Assertions.assertEquals(3, iter.next());
        Assertions.assertTrue(iter.hasNext()); // Still has more
    }

    @Test
    public void testGenerate_WithHasNextAndSupplier() {
        AtomicInteger counter = new AtomicInteger(0);
        ObjIterator<Integer> iter = ObjIterator.generate(
            () -> counter.get() < 3,
    ...
    public void testGenerate_WithInitAndBiPredicate() {
        ObjIterator<Integer> iter = ObjIterator.generate(
            0,
            (state, prev) -> prev == null || prev < 3,
            (state, prev) -> prev == null ? 1 : prev + 1
        );
    ...
    @Test
    public void testMap() {
        ObjIterator<String> iter = ObjIterator.of(1, 2, 3)
            .map(n -> "num" + n);
    ...
    public void testDistinctBy() {
        ObjIterator<String> iter = ObjIterator.of("a", "bb", "ccc", "dd", "e")
    ...
    public void testNegativeSkip() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> 
            ObjIterator.of(1, 2, 3).skip(-1));
    }

    @Test
    public void testNegativeLimit() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> 
            ObjIterator.of(1, 2, 3).limit(-1));
    }

    @Test
    public void testNegativeStartIndex() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> 
            ObjIterator.of("a", "b").indexed(-1));
    }

    @Test
    public void testNullIteratorSupplier() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> 
            ObjIterator.defer(null));
    }

    @Test
    public void testNullSupplier() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> 
            ObjIterator.generate((Supplier<String>) null));
    }

    @Test
    public void testNullHasNext() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> 
            ObjIterator.generate(null, () -> "test"));
    }

    @Test
    public void testNullPredicate() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> 
            ObjIterator.generate("init", null, state -> state));
    }

    @Test
    public void testNullBiPredicate() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> 
            ObjIterator.generate("init", null, (state, prev) -> state));
    }
