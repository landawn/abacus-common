...
public class Holder100Test extends TestBase {
    ...
    public void testIfNotNullOrElse() throws Exception {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> 
            holder.ifNotNullOrElse(null, () -> {})
        );
        Assertions.assertThrows(IllegalArgumentException.class, () -> 
            holder.ifNotNullOrElse(v -> {}, null)
        );
    }
    ...
    public void testOrElseThrowIfNullWithMessage() {
        ...
        NoSuchElementException ex = Assertions.assertThrows(NoSuchElementException.class, 
            () -> holder.orElseThrowIfNull("Custom error"));
    ...
    public void testOrElseThrowIfNullWithMessageAndParam() {
        ...
        holder.setValue(null);
        NoSuchElementException ex = Assertions.assertThrows(NoSuchElementException.class, 
            () -> holder.orElseThrowIfNull("Error: %s", "param1"));
    ...
    public void testOrElseThrowIfNullWithMessageAndTwoParams() {
        ...
        holder.setValue(null);
        NoSuchElementException ex = Assertions.assertThrows(NoSuchElementException.class, 
            () -> holder.orElseThrowIfNull("Error: %s %s", "param1", "param2"));
        Assertions.assertTrue(ex.getMessage().contains("param1"));
    ...
    public void testOrElseThrowIfNullWithMessageAndThreeParams() {
        ...
        holder.setValue(null);
        NoSuchElementException ex = Assertions.assertThrows(NoSuchElementException.class, 
            () -> holder.orElseThrowIfNull("Error: %s %s %s", "p1", "p2", "p3"));
    ...
    public void testOrElseThrowIfNullWithSupplier() {
        ...
        Assertions.assertThrows(IllegalStateException.class, 
            () -> holder.orElseThrowIfNull(() -> new IllegalStateException("Custom exception")));
        
        // Test null supplier
        holder.setValue(null);
        Assertions.assertThrows(IllegalArgumentException.class, 
            () -> holder.orElseThrowIfNull((Supplier<? extends Throwable>) null));
    }
    ...
    public void testHashCode() {
        ...
        // Different values likely have different hash codes (not guaranteed)
        // We can't assert they're different due to possible hash collisions
        
        // Null value should have hash code 0
    ...
    public void testEquals() {
        ...
        // Test equality
        Assertions.assertEquals(holder1, holder1); // Same instance
        Assertions.assertEquals(holder1, holder2); // Same value
        Assertions.assertNotEquals(holder1, holder3); // Different value
        Assertions.assertEquals(holderNull1, holderNull2); // Both null
        Assertions.assertNotEquals(holder1, holderNull1); // One null, one not
    ...
    public void testThreadSafety() throws InterruptedException {
        // Note: Holder is not thread-safe, this test just verifies basic behavior
        ...
        // Due to race conditions, the value might not be exactly 2000
    ...
    public void testComplexChaining() {
        ...
        Optional<Integer> result = holder
            .mapIfNotNull(String::toUpperCase)
            .mapIfNotNull(s -> s + "123")
            .mapToNonNullIfNotNull(String::length);
        
        Assertions.assertTrue(result.isPresent());
        Assertions.assertEquals(7, result.get()); // "TEST123".length()
        
        // Test with null breaking the chain
        holder.setValue(null);
        result = holder
            .mapIfNotNull(String::toUpperCase)
            .mapIfNotNull(s -> s + "123")
    ...
    public void testExceptionHandling() {
        ...
        // Test exception in updateAndGet
        Assertions.assertThrows(RuntimeException.class, () -> 
            holder.updateAndGet(v -> {
