...
public class ByteArrayOutputStream100Test extends TestBase {
    ...
    public void testCapacity() {
        ...
        // Write more than initial capacity to trigger growth
    ...
    public void testToByteArray() throws IOException {
        ...
        // Modifying result should not affect internal buffer
        result[0] = 'h';
    ...
    public void testClose() throws IOException {
        ...
        // Should still be able to use after close
        baos.write(" World".getBytes());
        assertEquals("Hello World", baos.toString());
    }
    ...
    public void testMixedWrites() throws IOException {
        ...
        baos.write((byte)'D');
        baos.write("EFGH".getBytes(), 1, 2); // "FG"
